...
public class Main {
    public static void main(String[] args) {
        ...
        // Balancing Parentheses with different types of parentheses
        BalanceParanthesisDiffParanthesis balanceDiffParanthesis = new BalanceParanthesisDiffParanthesis();
        Boolean result = balanceDiffParanthesis.isBalanced("([{}]){[(])}");
        System.out.println("the result of balancing different parentheses is: " + result);
    }
}
